...
OIDCFED_DEFAULT_TRUST_ANCHOR = "https://trust-anchor.paperopoli.derrigo.it"
...
OIDCFED_IDENTITY_PROVIDERS = {
  "spid": {
    "https://trust-anchor.paperopoli.derrigo.it/oidc/op" : OIDCFED_DEFAULT_TRUST_ANCHOR,
  },
  "cie": {
    "https://cie-provider.paperopoli.derrigo.it/oidc/op" : OIDCFED_DEFAULT_TRUST_ANCHOR,
  }
}
...
# Se True, un utente staff (Zio Paperone) dopo il login viene mandato alla
# "Relying Party test page" invece di completare il flusso verso il portale.
# Default: False -> test page bypassata, anche lo staff prosegue col consenso normale.
# (E' una decisione dell'OP/Django: non e' controllabile dall'appsettings del RP .NET.)
ABILITA_RP_TEST_PAGE = False
...
# La test page e' agganciata alla presenza dell'app relying_party_test in
# INSTALLED_APPS (vedi provider.get_url_consent e urls.py): la includiamo solo
# quando il toggle e' attivo.
if ABILITA_RP_TEST_PAGE:
    INSTALLED_APPS.append('spid_cie_oidc.relying_party_test')
