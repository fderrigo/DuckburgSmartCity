...
from spid_cie_oidc.onboarding.views import onboarding_registration
...
# "Registra il tuo ente" e' riservato: sovrascrive la rotta pubblica della libreria
# (matchata prima) con la stessa vista protetta da login. Chi non e' autenticato viene
# mandato al login admin. Solo Zio Paperone (staff) puo' registrare nuovi enti.
urlpatterns.append(
    path(
        "onboarding/registration",
        login_required(onboarding_registration, login_url=f"/{ADMIN_PATH}login/"),
